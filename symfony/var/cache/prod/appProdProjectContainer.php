...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'twig.extensions' => 'getTwig_ExtensionsService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebsiteAdminBundle', ($this->targetDirs[3].'/app/Resources/WebsiteAdminBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebsiteAdminBundle', ($this->targetDirs[3].'/src/Website/AdminBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebsiteCommonBundle', ($this->targetDirs[3].'/app/Resources/WebsiteCommonBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebsiteCommonBundle', ($this->targetDirs[3].'/src/Website/CommonBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy(1.3999999999999999, '%s?%s');
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('imGmq1lSnU', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TMFuHR+Oc4', 0, 'lO8bXXX+zT0OBSUwm6cCzg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WeTxq86vFk', 0, 'lO8bXXX+zT0OBSUwm6cCzg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'socleanu_db', 'user' => 'root', 'password' => 'abc123', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Website/CommonBundle/Entity'), 1 => ($this->targetDirs[3].'/src/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Website\\CommonBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('WebsiteCommonBundle' => 'Website\\CommonBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_87faa1da4996af5ef835ad4a648d90deb37e490decb9a7184431ec4761de3c9c');
    ...
    protected function getIvoryCkEditor_Form_TypeService()
    {
        ...
        $instance->setBasePath('bundles/websiteadmin/js/ckeditor');
        $instance->setJsPath('bundles/websiteadmin/js/ckeditor/ckeditor.js');
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'WebsiteCommonBundle:Pagination:sliding.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c, $d), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $this->get('security.authentication.session_strategy'), $m, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('redirect.after.login'), array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $o, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '580a80a72c53e0.62447662', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $m, '/login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('twig.extensions'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'WebsiteAdminBundle', 1 => 'WebsiteCommonBundle', 2 => 'UserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    /*
     * Gets the 'twig.extensions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Website\CommonBundle\Twig\Extensions A Website\CommonBundle\Twig\Extensions instance
     */
    protected function getTwig_ExtensionsService()
    {
        return $this->services['twig.extensions'] = new \Website\CommonBundle\Twig\Extensions($this->get('doctrine.orm.default_entity_manager'), $this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Website/CommonBundle/Resources/views'), 'WebsiteCommon');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c7d42ca2cff12bb83beeb769fc3819f9f4ff4bbe');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), ($this->targetDirs[3].'/app/../../public_html'), false);
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8U5ME2C+1Q', 0, 'lO8bXXX+zT0OBSUwm6cCzg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WebsiteCommonBundle' => 'Website\\CommonBundle\\WebsiteCommonBundle',
                'WebsitePublicBundle' => 'Website\\PublicBundle\\WebsitePublicBundle',
            ...
            'secret' => 'c7d42ca2cff12bb83beeb769fc3819f9f4ff4bbe',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'c7d42ca2cff12bb83beeb769fc3819f9f4ff4bbe',
            ...
            'validator.mapping.cache.prefix' => 'validator_a5be63305b5a8147ffcc17538c5013e568193a819616d6c80cb8c8ba216973b5',
            ...
            'assetic.bundles' => array(
                0 => 'WebsiteAdminBundle',
                1 => 'WebsiteCommonBundle',
                2 => 'UserBundle',
            ),
            ...
            'assetic.read_from' => ($this->targetDirs[3].'/app/../../public_html'),
            'assetic.write_to' => ($this->targetDirs[3].'/app/../../public_html'),
            ...
            'knp_paginator.template.pagination' => 'WebsiteCommonBundle:Pagination:sliding.html.twig',
